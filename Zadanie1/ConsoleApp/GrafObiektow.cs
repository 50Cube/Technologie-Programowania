...
namespace Zadanie2
{
    public class GrafObiektow 
    {
        public void Wypelnij(Kolekcje kolekcje)
        {
            ...
            obiektA4 = new KlasaA(10.5f, "NapisA4", new DateTime(2019, 11, 28), obiektB4);

            obiektC1 = new KlasaC(0.1f, "NapisC1", new DateTime(2019, 10, 10), obiektA1);
            obiektC2 = new KlasaC(0.2f, "NapisC2", new DateTime(2019, 10, 11), obiektA1);
            obiektC3 = new KlasaC(0.3f, "NapisC3", new DateTime(2019, 10, 12), obiektA1);
            obiektC4 = new KlasaC(0.4f, "NapisC4", new DateTime(2019, 10, 13), obiektA1);

            obiektB1 = new KlasaB(22.2f, "NapisB1", new DateTime(2019, 12, 06), obiektC1);
            obiektB2 = new KlasaB(33.3f, "NapisB2", new DateTime(2019, 12, 07), obiektC1);
            obiektB3 = new KlasaB(44.4f, "NapisB3", new DateTime(2019, 12, 08), obiektC1);
            obiektB4 = new KlasaB(55.5f, "NapisB3", new DateTime(2019, 12, 08), obiektC1);
